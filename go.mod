...
replace github.com/go-kratos/kratos/v2 => ./third_party/local/go-kratos

replace github.com/go-kratos/kratos/contrib/registry/kubernetes/v2 => ./third_party/local/contrib/registry/kubernetes
