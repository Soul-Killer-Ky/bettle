...
func (fd *FriendDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, FriendMutation](ctx, fd.sqlExec, fd.mutation, fd.hooks)
}
...
func (fd *FriendDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(friend.Table, sqlgraph.NewFieldSpec(friend.FieldID, field.TypeInt))
