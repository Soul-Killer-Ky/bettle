...
func RegisterImHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ImServer) error {
	...
	mux.Handle("GET", pattern_Im_ConnectIm_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Im_ConnectIm_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Im_ConnectIm_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterImHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImClient) error {
	...
	mux.Handle("GET", pattern_Im_ConnectIm_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Im_ConnectIm_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Im_ConnectIm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"im", "v1", "connect"}, "", runtime.AssumeColonVerbOpt(true)))
)
