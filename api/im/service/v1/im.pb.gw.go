...
func request_Im_Upload_0(ctx context.Context, marshaler runtime.Marshaler, client ImClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var metadata runtime.ServerMetadata
...
func RegisterImHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ImServer) error {
	...
	mux.Handle("POST", pattern_Im_Upload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterImHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImClient) error {
	...
	mux.Handle("POST", pattern_Im_Upload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.im.service.v1.Im/Upload", runtime.WithHTTPPathPattern("/im/v1/upload"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Im_Upload_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Im_Upload_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_Im_Upload_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"im", "v1", "upload"}, ""))
)

var (
	forward_Im_ConnectIm_0 = runtime.ForwardResponseMessage

	forward_Im_Upload_0 = runtime.ForwardResponseMessage
)
